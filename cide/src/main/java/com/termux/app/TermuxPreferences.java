...
final class TermuxPreferences {
    ...
    static TerminalSession getCurrentSession(Term context) {
        String sessionHandle = PreferenceManager.getDefaultSharedPreferences(context.getActivity()).getString(TermuxPreferences.CURRENT_SESSION_KEY, "");
