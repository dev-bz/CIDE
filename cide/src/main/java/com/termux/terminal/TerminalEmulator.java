            ...
            case 52: // Manipulate Selection Data. Skip the optional first selection parameter(s).
                ...
                try {
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
                        clipboardText = new String(Base64.decode(textParameter.substring(startIndex), 0), StandardCharsets.UTF_8);
                    } else {
                        clipboardText = new String(Base64.decode(textParameter.substring(startIndex), 0), Charset.defaultCharset());
                    }
